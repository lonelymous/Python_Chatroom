...
ipAddress = "0.0.0.0"
portNumber = 42068
serv = models.User(nickname="server",address=(ipAddress, portNumber), client=None, isAdmin=True, isServer=True)
BUFFER = 8192
stop_thread = False
    ...
    while True:
        ...
        try:
            ...
            #     pass
                ...
                Broadcast(message.encode('utf-8'), serv)
        except EOFError:
...
if __name__ == "__main__":
    try:
        ...
        if not databasee.ConnectDatabase():
            admins = ["admin"]
